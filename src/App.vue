...
export default {
  ...
  data: function() {
    return{
      ...
      url: "https://gobiernoabierto.cordoba.gob.ar/api/lugar-actividad/?categorias_id=10",
      urlBase: "https://gobiernoabierto.cordoba.gob.ar/api/lugar-actividad/",
      urlCategoriasBase: "https://gobiernoabierto.cordoba.gob.ar/api/lugar-actividad/?categorias_id=10",
      cargando: false,
      inicial: 10
    }
  },
